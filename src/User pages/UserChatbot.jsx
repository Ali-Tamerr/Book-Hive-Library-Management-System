    ...
    <div className="flex h-full w-full flex-col gap-6 px-[27px] py-[18px]">
      ...
      <div className="grid flex-1 min-h-0 gap-6 xl:grid-cols-[340px_1fr]">
        <div className="flex h-full flex-col gap-6">
          <section className="flex min-h-0 flex-1 flex-col rounded-2xl bg-white p-5 text-[#0a0f33] shadow-[0_12px_30px_rgba(15,23,42,0.08)] dark:bg-[#e2e4e9] dark:text-[#0a0f33]">
            <div className="flex items-center justify-between border-b border-gray-200 pb-3 dark:border-[#c7cbd4]">
              <h2 className="text-lg font-semibold">Conversation</h2>
              <span className="rounded-full bg-[#eef0f6] px-2 py-1 text-xs font-semibold text-[#4b5563] dark:bg-[#d6dae4] dark:text-[#0a0f33]">
            ...
            <div className="relative mt-4">
              ...
              <input
                ...
                className="w-full rounded-xl border border-gray-200 bg-white py-2.5 pl-9 pr-3 text-sm text-[#0a0f33] outline-none transition-colors placeholder:text-gray-400 focus:border-[#0a0f33] dark:border-[#b7bcc8] dark:bg-[#f3f4f7] dark:text-[#0a0f33] dark:placeholder:text-[#6b7280]"
              />
            </div>
                ...
                {conversations.map((conversation) => (
                  <button
                    ...
                    className={`flex w-full items-center justify-between rounded-xl border p-3 text-left transition-colors ${
                      conversation.active
                        ? "border-[#0a0f33] bg-[#f2f4f9] dark:border-[#0a0f33] dark:bg-[#d7dbe5]"
                        : "border-gray-200 bg-white hover:border-[#cbd5f5] dark:border-[#c7cbd4] dark:bg-[#f3f4f7] dark:hover:border-[#aab1be]"
                    }`}
                  >
          ...
          <section className="rounded-2xl bg-white p-5 text-[#0a0f33] shadow-[0_12px_30px_rgba(15,23,42,0.08)] dark:bg-[#e2e4e9] dark:text-[#0a0f33]">
        ...
        <section className="flex h-full min-h-0 flex-col rounded-2xl bg-white p-6 text-[#0a0f33] shadow-[0_12px_30px_rgba(15,23,42,0.08)] dark:bg-[#e2e4e9] dark:text-[#0a0f33]">
          <div className="flex flex-wrap items-center justify-between gap-4 border-b border-gray-200 pb-4 dark:border-[#c7cbd4]">
            <div className="flex items-center gap-3">
          ...
          <div className="mt-4 flex min-h-0 flex-1 flex-col gap-4 overflow-y-auto rounded-2xl bg-gradient-to-br from-[#f4f6fb] to-[#e7eaf3] p-6 dark:from-[#d6dae2] dark:to-[#cfd4de]">
                ...
                <div
                  className={`max-w-[70%] rounded-2xl px-4 py-2 text-sm shadow-sm ${
                    message.sender === "user"
                      ...
                      : "bg-white text-[#0a0f33] dark:bg-[#f7f8fb] dark:text-[#0a0f33]"
                  }`}
                >
                  {message.text}
                </div>
          ...
          <form
            className="mt-4 flex items-center gap-3 rounded-2xl border border-gray-200 bg-white p-3 shadow-sm dark:border-[#c7cbd4] dark:bg-[#f5f6fa]"
            onSubmit={(event) => event.preventDefault()}
          >
            <input
              type="text"
              placeholder="Type your message"
              className="flex-1 bg-transparent text-sm text-[#0a0f33] outline-none placeholder:text-gray-400 dark:text-[#0a0f33] dark:placeholder:text-[#6b7280]"
            />
            <button
              type="submit"
