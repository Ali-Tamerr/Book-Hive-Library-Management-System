...
const Testimonials = ({ feedbacks, testimonialPerView, isLoading = false }) => {
  ...
  return (
    <section className="py-18 pb-4" id="testimonial">
      <h2 className="mb-14 text-center font-[family-name:var(--body-font)] text-[68px] font-extrabold tracking-wide text-[var(--accent)] dark:!text-[var(--title-color)]">
        CUSTOMER OPINIONS
      </h2>
            ...
            >
              {isLoading ? (
                Array.from({ length: safePerView }).map((_, idx) => (
                  ...
                  >
                    <div className="mx-auto mb-8 flex h-[108px] w-[108px] items-center justify-center rounded-full bg-[#e6e7eb] dark:bg-[#171c29]">
                    ...
                    >
                      {fb.user_image || fb.image || fb.user_image_url ? (
                        ...
                        <div className="mx-auto mb-8 flex h-[92px] w-[92px] items-center justify-center rounded-full bg-[#000035] text-[#D7D7D7] dark:bg-[#171c29] dark:text-[#d3d6de]">
                          <i className="ri-user-line text-[54px]"></i>
                        </div>
                      )}
                      <h2 className="mb-5 font-[family-name:var(--body-font)] text-[42px] font-extrabold uppercase tracking-wide text-[#000035] dark:!text-[#d3d6de]">
                        {fb.user_name || fb.user_id || "Guest"}
                      </h2>
                      <p className="mx-auto mb-8 max-w-[740px] font-[family-name:var(--second-font)] text-[24px] font-bold leading-relaxed text-[#000035] dark:!text-[#c3c7d1]">
