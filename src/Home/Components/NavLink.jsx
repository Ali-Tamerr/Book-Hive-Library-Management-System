...
const NavLink = ({
  ...
  return (
    <li>
      ...
      >
        <i
          className={`${iconClass} text-[18px] text-inherit min-[1150px]:hidden`}
        ></i>
