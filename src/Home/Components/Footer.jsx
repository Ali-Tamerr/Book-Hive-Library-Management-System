    ...
    >
      <div className="footer-container mx-auto grid max-w-[1400px] grid-cols-[1.5fr_1fr_1fr_1fr] items-start gap-12 max-[950px]:grid-cols-2 max-[950px]:text-center max-[600px]:grid-cols-1">
        <div className="footer-col footer-brand max-[950px]:col-span-2 max-[600px]:col-span-1">
          <a
            href="#"
            className="footer-logo mb-6 flex items-center gap-3 text-[#000035] no-underline max-[950px]:justify-center dark:!text-white"
          >
            <img
              src={logoIcon}
              alt="Book Hive Logo"
            ...
            <div className="logo-text flex flex-col justify-center text-left">
              <span className="name font-[family-name:var(--body-font)] text-[26px] font-extrabold uppercase leading-none tracking-wide text-[#000035] dark:!text-white">
                BOOKHIVE
              </span>
        ...
        <div className="footer-col max-[950px]:mt-6">
          <h3 className="footer-title mb-6 font-[family-name:var(--body-font)] text-[34px] font-extrabold uppercase tracking-wide text-[#000035] dark:!text-white">
            ABOUT
          </h3>
          <ul className="footer-links list-none space-y-5">
            <li className="font-[family-name:var(--second-font)] text-[15px] font-bold text-[#525252] transition-colors hover:text-[#000035] dark:!text-[#D7D7D7] dark:hover:!text-white">
        ...
        <div className="footer-col max-[950px]:mt-6 max-[950px]:flex max-[950px]:flex-col max-[950px]:items-center">
          ...
          <div className="footer-social flex gap-5">
            <a
              href="#"
              className="text-[26px] text-[#525252] transition-colors hover:text-[#000035] dark:!text-[#D7D7D7] dark:hover:!text-white"
            >
