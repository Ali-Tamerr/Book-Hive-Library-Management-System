...
const Footer = ({ logoIcon }) => {
  return (
    <footer
      className="footer px-5 pb-[40px] pt-[80px] font-[family-name:var(--second-font)] text-[#000035] dark:!bg-[#101114]"
      data-reveal
    >
      <div className="footer-container mx-auto grid max-w-[1400px] grid-cols-[1.5fr_1fr_1fr_1fr] items-start gap-12 max-[950px]:grid-cols-2 max-[950px]:text-center max-[600px]:grid-cols-1">
        <div className="footer-col footer-brand max-[950px]:col-span-2 max-[600px]:col-span-1">
          ...
          <p className="footer-description font-[family-name:var(--second-font)] text-[15px] font-bold leading-[1.8] text-[#000035] dark:!text-[#D7D7D7]">
        ...
        <div className="footer-col max-[950px]:mt-6">
          ...
          <ul className="footer-links list-none space-y-5">
            <li className="font-[family-name:var(--second-font)] text-[15px] font-bold text-[#000035] transition-colors hover:text-[#000035] dark:!text-[#D7D7D7] dark:hover:!text-[#D7D7D7]">
        ...
        <div className="footer-col max-[950px]:mt-6">
          ...
          <ul className="footer-links list-none space-y-5">
            <li className="font-[family-name:var(--second-font)] text-[15px] font-bold text-[#000035] dark:!text-[#D7D7D7]">
              Cairo, Egypt
            </li>
            <li className="font-[family-name:var(--second-font)] text-[15px] font-bold text-[#000035] dark:!text-[#D7D7D7]">
              BookHive@gmail.com
        ...
        <div className="footer-col max-[950px]:mt-6 max-[950px]:flex max-[950px]:flex-col max-[950px]:items-center">
          ...
          <div className="footer-social flex gap-5">
            <a
              href="#"
              className="text-[26px] text-[#000035] transition-colors hover:text-[#000035] dark:!text-[#D7D7D7] dark:hover:!text-[#D7D7D7]"
            >
      ...
      <div className="mx-auto mt-24 max-w-[1400px]">
        <p className="text-center font-[family-name:var(--second-font)] text-[18px] font-extrabold text-[#000035] dark:!text-[#000035]">
