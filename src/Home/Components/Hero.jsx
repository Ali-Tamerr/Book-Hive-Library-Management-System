    ...
    <section className="home py-20 pb-4" id="home">
      <div className="home__container mx-auto grid w-full max-w-[1220px] gap-x-6 gap-y-10 px-6 pt-8 min-[1220px]:grid-cols-[435px_745px] min-[1220px]:items-center min-[1220px]:pb-8 min-[1220px]:pt-28">
        <div
          ...
          data-reveal
        >
          <h1 className="home__title mb-4 font-[family-name:var(--body-font)] text-[length:var(--biggest-font-size)] font-extrabold text-[var(--title-color)] dark:!text-[#c7c9cf]">
            One Library, <br />
            Infinite Stories
          </h1>
          <p className="mb-8 font-[family-name:var(--second-font)] font-medium text-[var(--title-color)] text-[18px] min-[1220px]:mb-16 dark:!text-[#b9bbc1]">
                ...
                ? heroBooks.map((book, i) => (
                    ...
                    >
                      <img
                        src={book.image}
                        alt={book.name}
                        className="!h-[400px] !w-[300px] !max-w-none rounded-lg !object-cover dark:!rounded-[6px]"
                      />
                    </article>
                  ))
                : null}
