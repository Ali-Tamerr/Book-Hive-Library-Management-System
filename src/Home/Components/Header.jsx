    ...
    <>
      ...
      >
        <nav className="flex h-[5rem] items-center justify-between px-6 max-[42.5rem]:h-[4.5rem] max-[42.5rem]:px-4 xl:pr-14">
          ...
          >
            <div
              className="h-[3rem] w-[3.375rem] bg-[var(--title-color)] dark:bg-[var(--title-color)]"
              style={{
          ...
          <div className="max-[71.875rem]:fixed max-[71.875rem]:inset-x-0 max-[71.875rem]:bottom-0 max-[71.875rem]:w-full max-[71.875rem]:bg-[var(--container-color)] max-[71.875rem]:px-6 max-[71.875rem]:py-5 max-[42.5rem]:px-4 max-[42.5rem]:py-4 max-[71.875rem]:shadow-[0_-0.5rem_2rem_hsla(0,0%,0%,0.1)] min-[71.875rem]:mx-auto min-[71.875rem]:flex min-[71.875rem]:flex-1 min-[71.875rem]:justify-center dark:max-[71.875rem]:shadow-[0_-0.5rem_2rem_hsla(0,0%,0%,0.4)]">
            <ul className="flex w-full items-center justify-between min-[71.875rem]:justify-around min-[71.875rem]:px-14">
              <NavLink
                href="#home"
                sectionId="home"
