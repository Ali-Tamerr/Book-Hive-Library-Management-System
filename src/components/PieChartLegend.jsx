...
const PieChartLegend = ({ variant = 'mobile' }) => {
  if (variant === 'mobile') {
    return (
      <div className="max-[340px]:scale-70 hidden items-center gap-7 whitespace-nowrap rounded-md border bg-white p-5 max-[1540px]:flex max-[1080px]:scale-90 dark:border-[#292D32] dark:bg-[#D7D7D7] dark:text-black">
