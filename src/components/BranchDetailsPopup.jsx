...
const BranchDetailsPopup = ({ isOpen, onClose, branch }) => {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/50">
      <div className="w-[90%] max-w-[420px] rounded-lg bg-white p-5 shadow-[0_8px_24px_rgba(0,0,0,0.2)] dark:bg-[#121317] dark:text-[#E8E8E8]">
        ...
        <button
          className="mt-3 cursor-pointer rounded-md border-none bg-[#bec3ce] px-3 py-2 text-white dark:bg-[#292D32] dark:text-[#E8E8E8]"
          onClick={onClose}
        >
          Close
        </button>
