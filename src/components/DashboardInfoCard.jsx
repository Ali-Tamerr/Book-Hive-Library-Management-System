  ...
  return (
    <div className="pr-23 [1200px]:px-5 [1200px]:py-5 flex h-[126px] w-full min-w-0 max-w-[450px] items-center gap-3.5 rounded-xl bg-white py-3 pl-5 max-[1540px]:h-full max-[1540px]:flex-1 max-[1540px]:scale-90 max-[1540px]:pl-2 max-[1540px]:pr-8 max-[650px]:h-[70px] max-[650px]:max-w-full max-[650px]:scale-100 max-[650px]:gap-2 max-[650px]:py-1 max-[650px]:pl-1.5 max-[650px]:pr-4 dark:bg-[#D7D7D7]">
      ...
      <div className="flex-2 [1200px]:ml-5 [1200px]:justify-self-center flex min-w-0 flex-col text-[#0a0f33] max-[1200px]:w-fit max-[650px]:ml-1 max-[650px]:mt-0 dark:text-[#121317]">
        <span className="-mb-1 ml-0.5 truncate text-[43px] font-extrabold max-[1200px]:w-fit max-[650px]:text-[22px]">
