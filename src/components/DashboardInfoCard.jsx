...
const DashboardInfoCard = ({ icon, title, value, loading }) => {
  return (
    <div className="bg-white max-w-[500px] w-full h-26 max-[1540px]:flex-1 max-[1540px]:scale-90 max-[1080px]:min-w-[230px] rounded-lg p-4 flex items-center gap-4 shadow-[0_4px_10px_rgba(0,0,0,0.05)]">
