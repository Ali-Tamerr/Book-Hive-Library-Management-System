...
const OurBranchesPopup = ({ isOpen, onClose }) => {
  ...
  return (
    <div
      className="fixed inset-0 z-[300] flex items-center justify-center bg-[rgba(140,140,140,0.7)] dark:bg-[rgba(10,10,12,0.7)] min-[48.0625rem]:p-8"
      onClick={onClose}
    >
      <div
        className="branches-popup popup-typography flex h-full max-h-none w-full flex-col gap-2.5 overflow-hidden rounded-none bg-white px-4 pb-7 pt-3 shadow-[0_0.75rem_1.75rem_rgba(10,10,35,0.18)] max-[43.75rem]:gap-1.5 max-[43.75rem]:pb-5 dark:bg-[#14161b] dark:shadow-[0_0.75rem_1.75rem_rgba(0,0,0,0.45)] min-[48.0625rem]:h-auto min-[48.0625rem]:max-h-[90vh] min-[48.0625rem]:w-[min(58.75rem,96vw)] min-[48.0625rem]:rounded-[0.625rem] min-[48.0625rem]:border min-[48.0625rem]:border-[#d1d1dd] min-[48.0625rem]:px-[1.375rem] min-[48.0625rem]:dark:border-[#242732] max-[48rem]:justify-center"
        role="dialog"
        aria-modal="true"
      ...
      >
        ...
        <h3
          ...
          className="mt-2 font-[family-name:var(--body-font)] text-2xl font-extrabold text-[#0a0b2b] max-[43.75rem]:text-[1.25rem] dark:text-[#f1f2f6]"
        >
          Our Branches
        </h3>

        <div className="mt-2.5 overflow-auto border-t border-[#9a9aa7] pt-2.5 dark:border-[#2b2f3a]">
          <table className="w-full min-w-[38.75rem] border-collapse max-[43.75rem]:min-w-[32.5rem]">
            <thead>
              <tr className="*:border-b *:border-[#9a9aa7] *:p-2.5 *:text-left *:text-[0.8125rem] *:font-bold *:text-[#0a0b2b] dark:*:border-[#2b2f3a] dark:*:text-[#e3e6f0]">
                <th>Name</th>
                <th>Contact No</th>
                <th>Location</th>
                <th className="!w-[7.5rem] !text-center">Bo Quantity</th>
              </tr>
            </thead>
            <tbody>
              {isLoading ? (
                ...
                branches.map((branch, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="!w-[7.5rem] !text-center">{bookCount}</td>
                    </tr>
                  );
                })
              )}
