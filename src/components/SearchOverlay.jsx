...
const SearchOverlay = ({ isOpen, onClose, onBookClick, setIsLoginOpen }) => {
  ...
  return (
    ...
    >
      <div className="container relative mx-auto flex h-full max-w-287.5 flex-col px-6">
        {/* Close Button */}
        <i
        ...
        <div className="flex h-full flex-col items-center gap-y-12 overflow-hidden">
          ...
          <div className="relative w-full max-w-200 shrink-0 overflow-hidden rounded-2xl border border-[#000035] transition-all focus-within:border-[#000053] dark:border-[#D7D7D7] dark:focus-within:border-white">
            ...
            <input
              ...
              className="w-full bg-transparent py-8 pl-20 pr-10 font-(family-name:--title-font) text-[1.625rem] text-[#000035] outline-none placeholder:text-[#000035] dark:text-[#D7D7D7] dark:placeholder:text-[#D7D7D7] max-[42.5rem]:py-5 max-[42.5rem]:pl-14 max-[42.5rem]:text-[1.125rem] [&::-webkit-search-cancel-button]:appearance-none [&::-webkit-search-decoration]:appearance-none [&::-webkit-search-results-button]:appearance-none [&::-webkit-search-results-decoration]:appearance-none"
              autoFocus={isOpen}
            />
          </div>
