...
const Sidebar = ({ activeTab, setActiveTab, isSidebarOpen, toggleSidebar }) => {
    ...
    return (
        <>
            ...
            ></div>
            <aside
                className={`bg-[#0a0f33] text-white justify-start flex flex-col items-start py-6 overflow-hidden transition-all duration-300 ${isExpanded ? 'w-55' : 'w-24'} max-[1080px]:fixed max-[1080px]:w-64 max-[1080px]:h-full max-[1080px]:z-50 max-[1080px]:transition-transform max-[1080px]:duration-300 ${isSidebarOpen ? 'max-[1080px]:translate-x-0' : 'max-[1080px]:translate-x-full'} max-[1080px]:right-0`}
            ...
            >
                ...
                {!isAdmin && <nav className="mt-10 flex flex-col w-full">
                    <NavLink
